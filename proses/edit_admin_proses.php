...
if (isset($_POST['simpan'])) {
    ...
    if ($foto != "") {
        ...
        if (in_array($ekstensi, $ekstensi_boleh) === true) {
            ...
            $query = "UPDATE users SET users.nama='$nama_admin', users.username='$username',
            ...
            if (!$result) {
                ...
                $_SESSION['pesan'] = '<div class="alert alert-success" role="alert">Data admin berhasil diperbarui</div>';
            }
        } else {
            //jika file ekstensi yang diupload tidak sesuai
            header('location:../admin/data-admin.php.php');
